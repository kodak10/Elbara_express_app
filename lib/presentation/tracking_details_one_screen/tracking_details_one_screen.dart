...
class TrackingDetailsOneScreen extends StatefulWidget {
  const TrackingDetailsOneScreen({Key? key}) : super(key: key);

  @override
  State<TrackingDetailsOneScreen> createState() =>
      _TrackingDetailsOneScreenState();
}

class _TrackingDetailsOneScreenState extends State<TrackingDetailsOneScreen> {
  TrackingDetailsOneController trackingDetailsOneController =
      Get.put(TrackingDetailsOneController());
        ...
        child: ColorfulSafeArea(
            ...
            child: Scaffold(
                ...
                appBar: CustomAppBar(
                    ...
                    centerTitle: true,
                    title: AppbarSubtitle1(text: "lbl_track_order".tr),
